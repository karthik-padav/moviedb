...
export default function Index(props) {
  return (
    <Container>
      <Box p={2}>
        <h1>Privacy Policy for howdy Internet</h1>

        <p>
          At movies.howdyinternet, accessible from www.movies.howdyinternet.com,
          one of our main priorities is the privacy of our visitors. This
          Privacy Policy document contains types of information that is
          collected and recorded by movies.howdyinternet and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in movies.howdyinternet. This policy is not
        ...
        <p>
          movies.howdyinternet follows a standard procedure of using log files.
        ...
        <p>
          ...
          advertising partners of movies.howdyinternet.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on movies.howdyinternet, which
        ...
        <p>
          Note that movies.howdyinternet has no access to or control over these
        ...
        <p>
          movies.howdyinternet's Privacy Policy does not apply to other
        ...
        <p>
          movies.howdyinternet does not knowingly collect any Personal
